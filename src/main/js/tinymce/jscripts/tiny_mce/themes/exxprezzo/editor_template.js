...
(function(tinymce) {
	...
	tinymce.ThemeManager.requireLangPack('exxprezzo');

	tinymce.create('tinymce.themes.ExxprezzoTheme', {
...
*/
	...
	tinymce.ThemeManager.add('exxprezzo', tinymce.themes.ExxprezzoTheme);
}(tinymce));
